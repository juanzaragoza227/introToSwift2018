...
//  Tasks
//
//  1) Hurricane Maria struck again and unfrotunately has hit this codebase hard. A bunch of code was erased and altered as a result and the codebase is not compiling. Please help in getting the codebase compiling without warnings or errors :)
//
...
//
//  5) Modify the table view so that any active keyboard is dismissed when the user drags on the view
//
